...
public class CompanyPresetBundle extends BasicBundle<String> {
    ...
    public CompanyPresetBundle() {
        super(new ArrayList<String>() {{
            ...
            add("Corn Products International Inc."); add("Corning Inc.");
            add("Costco Wholesale Corp."); add("Countrywide Credit Industries Inc.");
            add("Coventry Health Care Inc."); add("Cox Communications Inc.");
            add("Crane Co."); add("Crompton Corp.");
            add("Crown Cork & Seal Co. Inc."); add("CSK Auto Corp.");
            add("CSX Corp."); add("Cummins Inc."); add("CVS Corp.");
            add("Cytec Industries Inc.");
            add("D&K Healthcare Resources Inc."); add("D.R. Horton Inc.");
            add("Dana Corporation"); add("Danaher Corporation");
            add("Darden Restaurants Inc."); add("DaVita Inc.");
            add("Dean Foods Company"); add("Deere & Company"); add("Del Monte Foods Co");
            add("Dell Computer Corporation");
            add("Delphi Corp."); add("Delta Air Lines Inc.");
            add("Deluxe Corporation"); add("Devon Energy Corporation");
            add("Di Giorgio Corporation"); add("Dial Corporation");
            add("Diebold Incorporated"); add("Dillards Inc.");
        }});
    }
}
