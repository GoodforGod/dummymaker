...
public class PhrasePresetBundle extends BasicBundle<String> {
    ...
    public PhrasePresetBundle() {
        super(
                ...
                "A drop in the ocean", "A fate worse than death", "A feather in ones cap",
                "A fish rots from the head down",
                "A fish out of water", "A fly in the ointment", "A fool and his money are soon parted",
                "A fools paradise",
                "A foot in the door",
                ...
                "À la carte", "À la mode", "A legend in ones own lifetime", "A leopard cannot change its spots",
                "A little bird told me",
                "A little knowledge is a dangerous thing",
                "A little of what you fancy does you good",
                "A load of cobblers", "A load of codswallop", "A man after my own heart",
                "A man who is his own lawyer has a fool for a client",
                "A ministering angel shall my sister be",
                "A miss is as good as a mile",
                "A nation of shopkeepers", "A nest of vipers", "A no-brainer", "A norange",
                "A picture is worth a thousand words",
                "A piece of the action",
                "A pig in a poke",
                "A place for everything and everything in its place",
                "A plague on both your houses", "A priori", "A red rag to a bull",
                "A riddle wrapped up in an enigma",
                "A rolling stone gathers no moss",
                "A rose by any other name would smell as sweet",
                "A rose is a rose is a rose", "A safe pair of hands",
                "A sea change", "A skeleton in the closet", "A sledgehammer to crack a nut",
                "A shot in the arm",
                "A sight for sore eyes", "A sorry sight", "A stitch in time saves nine",
                "A stones throw", "A thing of beauty is a joy forever", "A tinkers damn",
                "A turn up for the books", "A watched pot never boils", "A wolf in sheeps clothing",
