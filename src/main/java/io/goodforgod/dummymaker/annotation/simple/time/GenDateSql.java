...
import io.goodforgod.dummymaker.generator.simple.time.factory.DateSqlAnnotationGeneratorFactory;
 ...
 * @since 10.03.2019
 */
@GenCustomFactory(DateSqlAnnotationGeneratorFactory.class)
