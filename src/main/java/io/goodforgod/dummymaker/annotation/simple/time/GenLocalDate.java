...
import io.goodforgod.dummymaker.generator.simple.time.factory.LocalDateAnnotationGeneratorFactory;
 ...
 * @since 21.02.2018
 */
@GenCustomFactory(LocalDateAnnotationGeneratorFactory.class)
