...
import io.goodforgod.dummymaker.generator.simple.time.factory.PeriodAnnotationGeneratorFactory;
 ...
 * @see io.goodforgod.dummymaker.generator.simple.time.PeriodGenerator
 * @since 09.04.2023
 */
@GenCustomFactory(PeriodAnnotationGeneratorFactory.class)
@Retention(value = RetentionPolicy.RUNTIME)
@Target(ElementType.FIELD)
public @interface GenPeriod {
