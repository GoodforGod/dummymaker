...
import io.goodforgod.dummymaker.generator.simple.time.factory.InstantAnnotationGeneratorFactory;
 ...
 * @since 12.11.2022
 */
@GenCustomFactory(InstantAnnotationGeneratorFactory.class)
